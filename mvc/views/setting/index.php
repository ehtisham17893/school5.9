        ...
        <div class="box-body">
            <fieldset class="setting-fieldset">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?php if (form_error('language_status')) {
                                                    echo 'has-error';
                                                } ?>">
                            <div class="col-sm-12">
                        ...
                        <div class="form-group <?= form_error('lang') ? 'has-error' : '' ?>">
                            <div class="col-sm-12">
                                ...
                                echo form_dropdown(
                                    ...
                                    set_value("lang", $setting->language),
                                    "id='lang' class='form-control select2'"
                                );
                                ?>
                                <span class="control-label">
                                    <?= form_error('lang'); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?php if (form_error('weekends')) {
                                                    echo 'has-error';
                                                } ?>">
                            <div class="col-sm-12">
                                ...
                                $expHoliday = isset($setting->weekends) ? explode(',', (string) $setting->weekends) : [];
                        ...
                        <div class="form-group <?= form_error('frontendorbackend') ? 'has-error' : '' ?>">
                            <div class="col-sm-12">
                                ...
                                echo form_dropdown(
                                    ...
                                    set_value("frontendorbackend", $setting->frontendorbackend),
                                    "id='frontendorbackend' class='form-control select2'"
                                );
                                ?>
                                <span class="control-label">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?php if (form_error('profile_edit')) {
                                                    echo 'has-error';
                                                } ?>">
                            <div class="col-sm-12">
            ...
            <fieldset class="setting-fieldset">
                <legend class="setting-legend"><?= $this->lang->line('setting_license_code') ?></legend>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?php if (form_error('license_code')) {
                                                    echo 'has-error';
                                                } ?>">
                            <div class="col-sm-12">
                                <label><?= $this->lang->line("setting_license_code") ?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Update your license code copied from INILABS."></i>
                                </label>
                                <input type="text" class="form-control" id="license_code" name="license_code" value="<?= set_value('license_code', $setting->license_code) ?>" >
                                <span class="control-label">
            ...
            <fieldset class="setting-fieldset">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?php if (form_error('auto_update_notification')) {
                                                    echo 'has-error';
                                                } ?>">
                            <div class="col-sm-12">
            ...
            <fieldset class="setting-fieldset">
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if (form_error('captcha_status')) {
                                                echo 'has-error';
                                            } ?>">
                        <div class="col-sm-12">
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if (form_error('recaptcha_site_key')) {
                                                echo 'has-error';
                                            } ?>" id="recaptcha_site_key_id">
                        <div class="col-sm-12">
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if (form_error('recaptcha_secret_key')) {
                                                echo 'has-error';
                                            } ?>" id="recaptcha_secret_key_id">
                        <div class="col-sm-12">
            ...
            <fieldset class="setting-fieldset">
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if (form_error('attendance_notification')) {
                                                echo 'has-error';
                                            } ?>">
                        <div class="col-sm-12">
                ...
                <div class="col-sm-4" id="mainSmsDiv">
                    <div class="form-group <?php if (form_error('attendance_smsgateway')) {
                                                echo 'has-error';
                                            } ?>" id="attendance_smsgateway_div">
                        <div class="col-sm-12">
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if (form_error('attendance_notification_template')) {
                                                echo 'has-error';
                                            } ?>" id="attendance_notification_template_div">
                        <div class="col-sm-12">
                ...
                <ul class="list-unstyled clearfix">
                    ...
                    ?>
                            ...
                            <li class="backendThemeMainWidht" style="float:left; padding: 5px;">
                                <a id="<?= $theme->themesID ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?= $theme->themename ?>" data-skin="skin-green-light" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4); cursor: pointer;" class="clearfix full-opacity-hover backendThemeEvent">
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <span class="backendThemeBodyHeight" style="display:block; width: 80%; float: left; background: #f4f5f7" id="themeBodyContent-<?= strtolower(str_replace(' ', '', (string) $theme->themename)) ?>">
                                            <?php  ?>
                                            <?php if ($setting->backend_theme == strtolower(str_replace(' ', '', (string) $theme->themename))) { ?>
