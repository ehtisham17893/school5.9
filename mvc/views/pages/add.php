    ...
    <div class="row">
        <div class="col-md-8">
            <div class="add--page--wrap">
                <h3><?=$this->lang->line('pages_add_new_page')?></h3>

                <div class="form-group <?=form_error('title') ? 'has-error' : '' ?>">
                    <input type="text" id="title" value="<?=set_value('title')?>" name="title" class="form-control" placeholder="<?=$this->lang->line('pages_enter_title_here')?>">
                    ...
                    <div class="permalink-area" <?=($send_url['status']) ? 'style="display:block"' : 'style="display:none"' ?>>
                        <span class="permalink-text"><?=$this->lang->line('pages_permalink')?>:</span> 
                        <span class="permalink"><?=base_url('frontend/page/')?><span class="editable-permalink-name"><?=($send_url['status']) ? $send_url['url'] : '' ?></span><input id="url" name="url" class="url" type="text" value="<?=($send_url['status']) ? $send_url['url'] : '' ?>" style="display: none" ></span>
                        <span><input id="permalink-edit" type="button" value="<?=$this->lang->line('pages_sm_edit')?>"></span>
                        <span id="editable-permalink-section" style="display: none">
                            <span id="save-permalink">
                                <input type="button" value="<?=$this->lang->line('pages_ok')?>">
                            </span>
                            <span class="cancel-permalink" id="cancel-permalink"><?=$this->lang->line('pages_cancel')?></span>
                        </span>
                    </div>
                ...
                <div class="form-group has-error">
                    <span class="add--media" data-toggle="modal" data-target="#mediaLibrary"><i class="fa fa-camera"></i><?=$this->lang->line('pages_add_media')?></span>
            ...
            <aside class="page--right--sidebar">
                <div class="bg-white mb-15">
                    <div class="sidebar--header">
                        <h4><?=$this->lang->line('pages_publish')?></h4>
                    ...
                    <div class="sidebar-body" id="publish-box">
                        <div class="save-preview-btn clearfix">
                            <!-- <a href="#" class="btn-preview pull-right"><?=$this->lang->line('pages_preview')?></a> -->

                            <button type="submit" id="preview" class="save-preview-btn pull-right clearfix" value="preview" name="submit"><?=$this->lang->line('pages_preview')?></button>

                            <?php
                                if ($send_status == 'draft') {
    echo '<button type="submit" class="btn-save-status pull-left" value="draft" name="submit">'.$this->lang->line('pages_save_draft').'</button>';
} elseif ($send_status == 'review') {
    echo '<button type="submit" class="btn-save-status pull-left" value="review" name="submit">'.$this->lang->line('pages_save_as_pending').'</button>';
}
                            ?>
                        ...
                        <div class="post-status">
                            ...
                            <?=$this->lang->line('pages_status')?>:
                            <span id="status-message" class="bold">
                                <?php
                                    if ($send_status == 'draft') {
                                echo $this->lang->line('pages_draft');
                            } elseif ($send_status == 'review') {
                                echo $this->lang->line('pages_pending_review');
                            }
                                ?>
                                
                            </span>
                            <a href="#" class="post-edit" id="draft-edit"><?=$this->lang->line('pages_edit')?></a>
                            <div class="post-status-select" id="draft-edit-show">
                                <?php 
                                    $statusArray = array(
                                        'review' => $this->lang->line('pages_pending_review'),
                                        'draft' => $this->lang->line('pages_draft')
                                    );
                                    echo form_dropdown("status", $statusArray, set_value("status", 'draft'), "id='status'"); 
                                ?>
                                <a href="#" id="save-status" class="save-post-status"><?=$this->lang->line('pages_ok')?></a>
                                <a href="#" id="cancle-draft" class="cancel-post-status"><?=$this->lang->line('pages_cancel')?></a>
                            </div>
                        </div>
                        <div class="post-status">
                            <i class="fa fa-eye"></i>
                            <?=$this->lang->line('pages_visibility')?>:
                            <span id="visibility-message" class="bold">
                                <?php 
                                    if ($send_visibility == 1) {
                                        echo $this->lang->line('pages_public');
                                    } elseif ($send_visibility == 2) {
                                        echo $this->lang->line('pages_password_protected');
                                    } elseif ($send_visibility == 3) {
                                        echo $this->lang->line('pages_private');
                                    } 
                                ?>
                                
                            </span>
                            <a href="#" class="post-edit" id="visibility-edit"><?=$this->lang->line('pages_edit')?></a>
                            <div class="post-status-select" id="visibility-edit-show">
                                <span id="visibility-all-data-set">
                                    ...
                                    <div class="form-group ini-dis-flex">
                                        ...
                                        <label for="private"><?=$this->lang->line('pages_private')?></label>
                                    </div>
                                </span>
                                <a href="#" id="save-visibility" class="save-post-status"><?=$this->lang->line('pages_ok')?></a>
                                <a href="#" id="cancel-visibility" class="cancel-post-status"><?=$this->lang->line('pages_cancel')?></a>
                            </div>
                        </div>
                        <div class="post-status">
                            <i class="fa fa-calendar-o"></i>
                            <?=$this->lang->line('pages_publish')?>: 
                            <span id="publish_message" class="bold">
                                <?php
                                    if($send_publish) {
                                        if ($send_date_status == 'same') {
                                            echo $this->lang->line('pages_immediately');
                                        } else {
                            ...
                            <a href="#" class="post-edit" id="publish-edit"><?=$this->lang->line('pages_edit')?></a>
                            <div class="post-status-select" id="publish-edit-show">
                                ...
                                <a href="#" id="save-publish" class="save-post-status"><?=$this->lang->line('pages_ok')?></a>
                                <a href="#" id="cancel-publish" class="cancel-post-status"><?=$this->lang->line('pages_cancel')?></a>
                            </div>
                        </div>
                    </div>
                    <div id="publish-box-footer" class="publish-btn text-right">
                        <input type="submit" name="submit" value="<?=$this->lang->line('pages_publish')?>">
                    </div>
                </div>

                <div class="bg-white mb-15">
                    <div class="sidebar--header">
                        <h4><?=$this->lang->line('pages_page_attribute')?></h4>
                    ...
                    <div class="sidebar-body" id="attribute-box">
                        <div class="pae-attribute">
                            <div class="form-group">
                                <label for="select-parent"><?=$this->lang->line('pages_template')?></label>
                                <?php
                                    $template_array = array('none' => 'None');
                                    if(customCompute($frontend_templates)) {
                                        foreach ($frontend_templates as $frontend_template) {
                                            $template_array[$frontend_template->template_name] = ucfirst((string) $frontend_template->template_name);
                                        }
                                    }
                                    echo form_dropdown("template", $template_array, set_value("template"), "id='template'");
                                ?>
                            </div>
                        </div>
                    </div>
...
<div id="visiblity" style="display: none;">
                <div class="bg-white mb-15">
                    <div class="sidebar--header">
                        <h4><?=$this->lang->line('pages_featured_image')?></h4>
                        <span id="featuredimage" class="flipup">
                            <i class="fa fa-caret-up"></i>
                        </span>
                    </div>
                    <div class="sidebar-body" id="featuredimage-box">
                        <div class="feauret-img-show" <?=customCompute($send_featured_image) ? 'data-toggle="modal" data-target="#SetFeaturedImage"' : '' ?> >
                            <?php
                                if(customCompute($send_featured_image)) {
                        ...
                        <span class="featured-image-btn <?=customCompute($send_featured_image) ? 'hide' : ''?>" data-toggle="modal" data-target="#SetFeaturedImage" id="set-featured-img"><?=$this->lang->line('pages_set_featured_image')?></span>
                        <span class="featured-image-btn <?=customCompute($send_featured_image) ? '' : 'hide'?>" onclick="removeFeatureImage(this, 'featured_image', 'feauret-img-show')"  id="remove-set-featured-img"><?=$this->lang->line('pages_remove_featured_image')?></span>
                    </div>
                </div>



                <div class="bg-white mb-15" id="visiblitya" style="display: none;">
                    <div class="sidebar--header">
                        <h4><?=$this->lang->line('pages_slider_images')?></h4>
                        <span id="sliderimages" class="flipup">
                            <i class="fa fa-caret-up"></i>
                        </span>
                    </div>
                    <input type="text" id="hidden_slider_images" name="hidden_slider_images" class="hide" value="<?=set_value('hidden_slider_images')?>">
                    <div class="sidebar-body sliderImages-box" id="sliderimages-box">
                        <div class="clearfix">
                            <div class="slider-pluck">
                                <?php if(customCompute($send_slider_images)) { foreach ($send_slider_images as $send_slider_image_key => $send_slider_image) {  ?>
                        ...
                        <span class="slider-images-btn featured-image-btn" data-toggle="modal" data-target="#SetSliderImages"><?=$this->lang->line('pages_set_slider_image')?></span>
                    </div>
                </div>
</div>
        ...
        <div class="modal-body">
            <div class="nav-tabs-custom media-sidebar clearfix">
                <ul class="pull-left media-sidebar-nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#insertMedia"><?=$this->lang->line('pages_insert_media')?></a></li>
                    <li class=""><a data-toggle="tab" href="#createGallery"><?=$this->lang->line('pages_create_gallery')?></a></li>
                    <li class=""><a data-toggle="tab" href="#createAudioPlaylist"><?=$this->lang->line('pages_create_audio_playlist')?></a></li>
                    <li class=""><a data-toggle="tab" href="#createVideoPlaylist"><?=$this->lang->line('pages_create_video_playlist')?></a></li>
                    <li class=""><a data-toggle="tab" href="#featuredImage"><?=$this->lang->line('pages_featured_image')?></a></li>
                </ul>
                ...
                <div class="tab-content media-sidebar-content pull-left">
                    ...
                    <div id="insertMedia" class="tab-pane active">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#insertMediaUpload"><?=$this->lang->line('pages_upload_files')?></a></li>
                                <li><a data-toggle="tab" href="#insertMediaUploadLibrary"><?=$this->lang->line('pages_media_library')?></a></li>
                            </ul>
                                ...
                                <div id="insertMediaUploadLibrary" class="tab-pane clearfix">
                                    <div class="media-library-left pos-rel pull-left">
                                        ...
                                        <?php 
                                            ...
                                            if(customCompute($media_gallerys_all)) {
                    ...
                    <div id="createGallery" class="tab-pane">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#createGalleryMediaUpload"><?=$this->lang->line('pages_upload_files')?></a></li>
                                <li><a data-toggle="tab" href="#createGalleryMediaUploadLibrary"><?=$this->lang->line('pages_media_library')?></a></li>
                            </ul>
                            ...
                            <div class="tab-content no-padd">
                                ...
                                <div id="createGalleryMediaUploadLibrary" class="tab-pane clearfix">
                                    <div class="media-library-left pos-rel pull-left">
                                        ...
                                        <?php 
                                            if(customCompute($media_gallerys_images)) {
                                                echo '<div class="attached-preview">';
                    ...
                    <div id="createAudioPlaylist" class="tab-pane">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#createAudioPlaylistMediaUpload"><?=$this->lang->line('pages_upload_files')?></a></li>
                                <li><a data-toggle="tab" href="#createAudioPlaylistMediaUploadLibrary"><?=$this->lang->line('pages_media_library')?></a></li>
                            </ul>
                    ...
                    <div id="createVideoPlaylist" class="tab-pane">
                        <h2><?=$this->lang->line('pages_create_video_playlist')?></h2>
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#createVideoPlaylistMediaUpload"><?=$this->lang->line('pages_upload_files')?></a></li>
                                <li><a data-toggle="tab" href="#createVideoPlaylistMediaUploadLibrary"><?=$this->lang->line('pages_media_library')?></a></li>
                            </ul>
                            ...
                            <div class="tab-content no-padd">
                                ...
                                <div id="createVideoPlaylistMediaUploadLibrary" class="tab-pane clearfix">
                                    <div class="media-library-left pos-rel pull-left">
                                        ...
                                        <?php 
                                            if(customCompute($media_gallerys_videos)) {
                                                echo '<div class="attached-preview">';
                                                    echo '<ul class="create_video_playlist_type">';
                                ...
                                <div class="footer--upload">
                                    <a data-dismiss="modal" id="create_a_new_video_playlist" onclick="setFileToEditor(this, 'create_video_playlist_hidden_field', 'create_video_playlist_type');" href="#"><?=$this->lang->line('pages_create_a_new_video_playlist')?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="featuredImage" class="tab-pane">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#featuredImageMediaUpload"><?=$this->lang->line('pages_upload_files')?></a></li>
                                <li><a data-toggle="tab" href="#featuredImageMediaUploadLibrary"><?=$this->lang->line('pages_media_library')?></a></li>
                            </ul>
                            ...
                            <div class="tab-content no-padd">
                                ...
                                <div class="footer--upload">
                                    <a data-dismiss="modal" id="set_featured_image" onclick="setFileToEditor(this, 'featured_image_hidden_field', 'featured_image_type');" href="#"><?=$this->lang->line('pages_set_featured_image')?></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="setfeaturedImage" class="tab-pane">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#setfeaturedImageMediaUpload"><?=$this->lang->line('pages_upload_files')?></a></li>
                            <li><a data-toggle="tab" href="#setfeaturedImageMediaUploadLibrary"><?=$this->lang->line('pages_media_library')?></a></li>
                        </ul>
...
<div class="modal fade mediaLibrary new-pattern" id="SetSliderImages">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close btn-close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <div class="modal-body">
                <div id="setSliderImages" class="tab-pane">
                    <h2><?=$this->lang->line('pages_slider_images')?></h2>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#setSliderImagesMediaUpload"><?=$this->lang->line('pages_upload_files')?></a></li>
                            <li><a data-toggle="tab" href="#setSliderImagesMediaUploadLibrary"><?=$this->lang->line('pages_media_library')?></a></li>
                        </ul>
...
<script type="text/javascript">
    ...
    dropdown.addEventListener("change", function() {
        ...
        if (selectedValue == "home" || selectedValue == "about") {
            visiblity.style.display = "block";
                                            if (selectedValue == "home") {
                visiblitya.style.display = "block";
            } else {
                visiblitya.style.display = "none";
            }
        } else {
            visiblity.style.display = "none";
        }
        // Output the selected value (for demonstration purposes)
...
<script type="text/javascript">
    ...
    $(document).on('blur', '#file_title, #file_artist, #file_album, #file_caption, #file_alt_text, #file_description', function(){
        ...
        $.ajax({
            type: 'POST',
            url: "<?=base_url('pages/setFileInfo')?>",
    ...
    function setFileToEditor(ele, hiddenfield, ulClass) {
        ...
        if((hiddenfield != '' && hiddenfield != null) && (ulClass !='' && ulClass != null)) {
            ...
            $.ajax({
                dataType: "json", 
                type: 'POST',
                url: "<?=base_url('pages/setFileToEditor')?>",
                data: setAllDataBind,
                dataType: "html",
    ...
    function getFileInfo(ele, activeType, filetype, status, hiddenfield, combind, combindname) {
        ...
        if($(ele).hasClass("selected") == false) {
            ...
            $.ajax({
                dataType: "json", 
                type: 'POST',
                url: "<?=base_url('pages/getFileInfo')?>",
                data: setAllDataBind,
                dataType: "html",
                success: function(data) {
                    var response = jQuery.parseJSON(data);
    ...
    function deleteFileInfo(ele) {
        ...
        if(id) {
            $.ajax({
                dataType: "json", 
                type: "POST",
                url: "<?=base_url('pages/deleteFileInfo')?>",
                data: { "id":id },
                dataType: "html",
                success: function(data) {
                    var response = jQuery.parseJSON(data);
        ...
        $('.save-post-status').click(function(e) {
            ...
            if(id == 'save-status') {
                ...
                if(saveStatusValue == 'draft') {
                    saveStatusValue = "<?=$this->lang->line('pages_draft')?>";
                    btnSaveStatus = "draft";
                    btnInSaveStatus = "<?=$this->lang->line('pages_save_draft')?>";
                } else if(saveStatusValue == 'review') {
                    saveStatusValue = "<?=$this->lang->line('pages_pending_review')?>";
                    btnSaveStatus = "review";
                    btnInSaveStatus = "<?=$this->lang->line('pages_save_as_pending')?>";
                }
                ...
                if(saveVisibilityValue == 1) {
                    saveVisibilityValue = "<?=$this->lang->line('pages_public')?>";
                } else if(saveVisibilityValue == 2) {
                    saveVisibilityValue = "<?=$this->lang->line('pages_password_protected')?>";
                } else if(saveVisibilityValue == 3) {
                    saveVisibilityValue = "<?=$this->lang->line('pages_private')?>";
                }
                ...
                if(validDateChecker(get_date_convator)) {
                    if(current_date !== get_date) {
                        ...
                        if (typeof monthNames[Math.abs(parseInt(publish_month) -1)] !== 'undefined' && monthNames[Math.abs(parseInt(publish_month) -1)] !== null) {
                            ...
                            $('#publish_message').text("<?=$this->lang->line('pages_immediately')?>");
                        }
                    } else {
                        $('#publish_message').text("<?=$this->lang->line('pages_immediately')?>");
                    }
