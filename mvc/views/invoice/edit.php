                ...
                <form role="form" method="post" enctype="multipart/form-data" id="invoiceDataForm"> 
                    ...
                    <div class="dateDiv form-group <?=form_error('date') ? 'has-error' : '' ?>" >
                        <label for="date">
                            ...
                            <input type="text" class="form-control" id="date" name="date" value="<?=set_value('date', date('d-m-Y', strtotime((string) $maininvoice->maininvoicedate)))?>" >
                        <span class="text-red">
                    ...
                    <div class="paymentmethodDiv form-group <?=form_error('payment_method') ? 'has-error' : '' ?>" >
                        ...
                        <?php
                            ...
                            echo form_dropdown("payment_method", $paymentmethodArray, set_value("payment_method", "Cash"), "id='payment_method' class='form-control select2'");
                        ?>
                        <span class="text-red">
                                ...
                                if(customCompute($invoices)) {
                                    ...
                                    foreach ($invoices as $invoice) {
                                        ...
                                        echo '<tr id="tr_'.$randID.'" invoicefeetypeID="'.$invoice->feetypeID.'">';
                                            ...
                                            echo '<td>';
                                                echo  '<input type="text" class="form-control change-paidamount" id="td_paidamount_id_'.$randID.'" data-paidamount-id="'.$randID.'" readonly="readonly" value="'.$invoice->payment_amount.'">';
                                            echo '</td>';
